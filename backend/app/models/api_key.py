...
class ApiKey(Base):
    ...
    prefix = Column(String(20), nullable=False)  # First few chars for identification (e.g., "sk_test_abc...")
    scopes = Column(Text, nullable=False, default="read")  # Comma-separated: read, write, admin
